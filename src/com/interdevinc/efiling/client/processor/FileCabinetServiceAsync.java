...
public interface FileCabinetServiceAsync {
    ...
    public void addDocumentType(AuthenticatedUser au, FileCabinet fc, String documentTypeName, String documentTypeAbbr, AsyncCallback<String> callback);
    
    public void deleteDocumentType(AuthenticatedUser au, FileCabinet fc, String documentTypeAbbr, AsyncCallback<String> callback);
